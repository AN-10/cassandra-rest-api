...
module.exports = function() {
  return function alterAddTablesPropertiesValidation(req, res, next) {
    ...
    if (
      ...
      errorHandler.validateKeyspaceName(req.body.noOfRecords) &&
      errorHandler.validateKeyspaceName(req.body.tableName)
      //errorHandler.validateTableProperties(req.body.properties) I have commented it here because if user doesn't wants to 
      // add columns
    ) {
      next()
    }
     ...
     */
      ...
      } else if (!errorHandler.validateKeyspaceName(req.body.noOfRecords)) {
        next(  errorHandler.invalidProperty(" noOfRecords "))
      } else if (!errorHandler.validateKeyspaceName(req.body.tableName)) {
