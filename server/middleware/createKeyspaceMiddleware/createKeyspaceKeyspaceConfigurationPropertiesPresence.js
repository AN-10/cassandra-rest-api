...
module.exports = function() {
  return function createKeyspaceKeyspaceConfigurationPropertiesPresence(req, res, next) {
    /*
    ...
    if ( req.params.hasOwnProperty('keyspaceName') &&
      req.body.hasOwnProperty('keyspaceProperties') 
      ...
      } else if (!req.body.hasOwnProperty('keyspaceProperties')) {
        next(errorHandler.propertyMissing("keyspaceProperties"))
      }
    }
  };
};
