...
module.exports = function() {
  return function createTablesPropertiesPresence(req, res, next) {
    ...
    if ((req.params.hasOwnProperty('keyspaceName') &&
        ...
        req.body.hasOwnProperty('table_schema')) // if user doesn't provide table properties 
      ...
      } else if (!req.body.hasOwnProperty('table_schema')) {
        next(errorHandler.propertyMissing("table_schema"))
      }
